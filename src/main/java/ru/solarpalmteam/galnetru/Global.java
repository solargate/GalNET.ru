...
public class Global {
    ...
    public static final String RSS_FEED_DAYLY_REPORT  = "http://galnet.ru/news/by/tag/1.rss";  // Ежедневный отчет
    ...
    public static final String FEED_TYPE_DAYLY_REPORT = "DAYLY_REPORT";
